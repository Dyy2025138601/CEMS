	...
	<div class="layout">
		<div class="sidebar" id="sidebar">
			...
			<nav class="nav-menu">
				...
				</a> <a href="EventController?action=listCoordinatorEvents" class="nav-item"> <img
		...
		<main class="main">
			<div class="profile-box">
				...
				<button class="back-btn"
						onclick="window.location.href='EventController?action=dashboardCoordinator'">
				...
				<div id="view-phone" class="view" style="display: none;">
					...
					<div class="error-container">
						...
						<span class="error-text" style="color: #b80000; font-weight: 600;"><%=phoneError%></span>
					</div>
				...
				<div id="view-password" class="view" style="display: none;">
					...
					<div class="error-container">
						<i class="fa-solid fa-circle-exclamation" style="color: #b80000;"></i>
						<span class="error-text" style="color: #b80000; font-weight: 600;"><%=passError%></span>
					</div>
					...
					<form class="static-form" action="staffServlet" method="post">
						...
						<div class="input-block">
							<label>Confirm Password</label> <input type="password"
								id="input-confirm-pass" name="confirmPass" class="minimal-input"
								maxlength="8" required>
							<button type="submit" class="update-btn">Update</button>
						</div>
					</form>
